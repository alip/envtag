...
#define EXCEPTION(_msg)             \
    do {                            \
        lua_pop(L, 1);              \
        lua_pushnil(L);             \
        lua_pushliteral(L, _msg);   \
        return 2;                   \
    } while (0)
